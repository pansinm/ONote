...
import { FILE_CONTENT_CHANGED, NOTE_CREATE_REQUEST } from '../../eventbus/EventName';
...
const FileList: FC = observer(() => {
  ...
  useEffect(() => {
    eventbus.on(NOTE_CREATE_REQUEST, createNote);
    return () => {
      eventbus.off(NOTE_CREATE_REQUEST, createNote);
    };
