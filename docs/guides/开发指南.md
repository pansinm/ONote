...
├── docs/                  # 文档
├── node_modules/          # 依赖
├── package.json           # 根 package.json（Yarn Workspaces 配置）
...
```typescript
// packages/renderer/src/previewer/markdown/handlers/yourHandler.ts
...
```typescript
// packages/renderer/src/previewer/markdown/handlers/index.ts
